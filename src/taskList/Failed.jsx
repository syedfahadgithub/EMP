...
const Failed = ({data}) => {
  return (
    <div className='lowerCards w-60 h-68 shrink-0 bg-red-500 rounded-2xl'>
          ...
          <div className='p-2'>
            <button className='bg-red-500 font-medium text-white text-sm px-2 py-1 rounded'>Failed</button>
          </div>
        </div>
  )
}
